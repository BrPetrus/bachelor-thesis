...
\thesissetup{
    ...
    TeXkeywords = {segmentation, image processing, scikit-image, watershed,
                   thresholding, fluorescence microscopy, zero-crossing},
    abstract    = {%
        This thesis aims to develop an image analysis pipeline for segmenting membrane-stained and nuclei-stained image data obtained using a fluorescent microscope. The thesis describes a two-step processing using the analysis of the Laplacian operator and watershed algorithm in the first step and thresholding in the second step to segment individual cells in the image data. Then the program's segmentation accuracy and detection performance are evaluated using reference data. The thesis also includes the program with documentation on how to use it.
    },
    thanks      = {%
