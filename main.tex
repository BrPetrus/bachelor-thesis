...
\thesissetup{
    ...
    thanks      = {%
       ...
       I am grateful to Dr. Zuzana Sumbalová Koledová and Dr. Matea Brezak for providing
...
real cell, it segments it reasonably well. In the last row of the table, a
simple average of all the metrics is shown with the standard deviation. In
...
The last column indicates the average time in seconds taken to run the program --- on my computer with the Ryzen 5700U notebook processor --- on
