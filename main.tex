...
y)$ is defined as vector \cite{gonzalez2002}:
$$\nabla \textbf{f} =
\begin{bmatrix}
    G_x \\
    G_y
...
%todo: odsekavanie napr.
%todo: nejasne okraje sposobuju blbosti
%todo: sprajanie buniek dokopy
