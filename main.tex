...
The primary goal of this thesis was to develop a pipeline for automatic segmentation of membrane-stained image data from fluorescent microscopy. This is done to make it easier for researchers to analyse the behaviour of cells, by decreasing the time required to segment them. This program was supposed to be packaged in an easy to use form with exemplary usage documented.
