...
segmentation of membrane-stained image data from fluorescent microscopy.
...
find a course segmentation of the cells, while in the second step, this is
...
The program provides a practical, easy-to-use terminal interface. In Chapter
\ref{chp:evaluation}, all the available parameters are documented, with tips
